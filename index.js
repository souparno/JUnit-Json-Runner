...
shelljs.exec('javac -d ./palindromeString/build/classes/ ./palindromeString/src/palindromeString.java', {
  ...
  if (!code) {
    shelljs.exec('javac -d ./palindromeString/build/test/classes/ -cp ./lib/junit4-4.11.jar:./palindromeString/build/classes:./build/classes/ ./palindromeString/test/*.java', {
      silent: true
    }, function(code, output) {
      if (!code) {
